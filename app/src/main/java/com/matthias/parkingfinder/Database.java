...
public class Database
{
	...
	public static ArrayList<ParkingSpace> getStubList(Context context, GoogleMap gMap)
	{
		...
		chargingTime = new TimePeriod(0730,1630);
		nonParkingTime = new TimePeriod(0, 0);
		address = new Address("Saunderson St", streetNumber , zipCode);
		...
		chargingTime = new TimePeriod(0730,1630);
		nonParkingTime = new TimePeriod(0, 0);
		address = new Address("Service 7 St", streetNumber , zipCode);
		...
		chargingTime = new TimePeriod(0730,1630);
		nonParkingTime = new TimePeriod(0, 0);
		address = new Address("Dafoe Rd W", streetNumber , zipCode);
		...
		address = new Address("Service 1 Rd S", streetNumber , zipCode);
		...
		nonParkingTime = new TimePeriod(0, 0);
		address = new Address("Ralph Campbell Rd", streetNumber , zipCode);
